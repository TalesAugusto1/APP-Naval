...
export const Box = ({ children, testID, ...props }) =>
...
export const FormControlLabel = ({ children, ...props }) =>
  React.createElement('View', props, children);
export const FormControlLabelText = ({ children, ...props }) =>
  React.createElement('Text', props, children);
export const FormControlError = ({ children, ...props }) =>
  React.createElement('View', props, children);
export const FormControlErrorText = ({ children, ...props }) =>
  React.createElement('Text', props, children);
